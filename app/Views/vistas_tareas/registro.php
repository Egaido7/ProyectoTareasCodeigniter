...
<main class="form-register w-100 m-auto">
  <?= form_open(base_url('controlador_tareas/registro/getregistrarse'), ['class' => 'text-center']) ?>
...
<?php endif; ?>
    ...
    <p class="mt-4 mb-3 text-body-secondary text-center">
        ¿Ya tienes cuenta? <a href="<?= base_url('controlador_tareas/login') ?>">Inicia Sesión</a>
    </p>
...
<?php
        ...
        // El usuario ha iniciado sesión, redirige a la página de tarea
